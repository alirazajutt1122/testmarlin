...
export class MarketWatchEquities implements AfterViewInit {
    exchanges = [];
    markets = [];
    data: any[] = [];
    ...
    constructor(private appState: AppState, private listingSvc: ListingService, private dataService: DataServiceOMS,
        ...
        private storageService: StorageService,private translate: TranslateService, private splash: FuseLoaderScreenService,) {
