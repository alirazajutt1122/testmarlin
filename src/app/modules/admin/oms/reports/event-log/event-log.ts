...
export class EventLog implements OnInit, AfterViewInit {
    ...
    updateMarketData(markets) {
        ...
        if (this.markets.length > 0) {
            ...
            //   let a = {"marketId" : 0 , "marketCode" : "Select" , "marketDesc" : ""};
    ...
    exportPDF() {
        gridPdf.FlexGridPdfConverter.export(this.flexGrid, 'EventLog ' + new Date().toLocaleString() + '.pdf', {
            maxPages: 10,
