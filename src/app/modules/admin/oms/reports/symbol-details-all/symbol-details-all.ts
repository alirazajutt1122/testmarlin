...
@Component({
  selector: 'symbol-details-all',
  templateUrl: './symbol-details-all.html',
  styleUrls: ['../component.style.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SymbolDetailsAll implements OnInit{
    ...
    constructor(private appState: AppState, public authService: AuthService2, private dataService: DataServiceOMS,
        ...
        private _fb: FormBuilder,private translate: TranslateService, public auth2Service : AuthService2,  private router : Router , public cdr : ChangeDetectorRef){
