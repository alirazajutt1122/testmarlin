...
@Component({
  selector: 'negotiated-equity-initiate-order',
  templateUrl: './negotiated-equity-initiate-order.html',
})

export class NegotiatedEquityInitiateOrderComponent {
  ...
  init() {
    ...
    this.order.negotiated_order_state = "Initiate";
