...
@Component({
  selector: '[negotiated-equity-accept-order]',
  templateUrl: './negotiated-equity-accept-order.html',
  encapsulation: ViewEncapsulation.None,
})

export class NegotiatedEquityAcceptOrderComponent {
  ...
  @ViewChild('negotiated-deals', { static: false }) NegotiatedDealsComponent: NegotiatedDealsComponent;
  ...
  constructor(
    ...
    public authServiceOMS: AuthService,
    ...
    public shareOrderService: ShareOrderService,
  ...
  ngOnChanges(changes: SimpleChanges): void {
    debugger
    if (changes.itemFromParent || changes.sharedIndex) {
