 ...
 *********************************/
  ...
  public printReport(model: any, isValid: boolean) {
    ...
    if (this.sms) {
      this.AccountHoldingFormatWithSMS(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
      this.isValidReport = true;
    }
    else if (this.activeSMS) {
      this.AccountHoldingFormatWithActiveSMS(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
      this.isValidReport = true;
    }
    else {
      ...
      if (isValid) {
        ...
        if (this.reportType.toLowerCase() == 'format-1' || this.reportType.toLowerCase() == 'formato-1') {
          ...
          if (this.email) {
            this.AccountHoldingFormatWithEmail(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
          } else {
            this.AccountHoldingFormatWithOutEmail(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
          }
        }
        else if (this.reportType.toLowerCase() == 'psx-format' || this.reportType.toLowerCase() == 'psx-formato') {
          if (this.email) {
            this.AccountHoldingFormat2WithEmail(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
          } else {
            this.AccountHoldingFormat2WithOutEmail(this.params, exchange, security, branch, startDate, endDate, agent, this.lang);
          }
        }
      }
    }
  ...
  public AccountHoldingFormatWithOutEmail(params, exchange, security, branch, startDate, endDate, agent, lang) {
    this.reportService.getAccountHoldingFormat1(params.PARTICIPANT_ID, startDate, endDate, params.EXCHANGE_ID,
      ...
      encodeURIComponent(params.TO_ACCOUNT.valueOf()), params.SECURITY_ID, security, params.AGENT_ID, agent, this.mail, lang)
      .subscribe(
        restData => {
          this.loader.hide();
          var reportData: any;
  ...
  public AccountHoldingFormat2WithOutEmail(params, exchange, security, branch, startDate, endDate, agent, lang) {
  ...
  public AccountHoldingFormat2WithEmail(params, exchange, security, branch, startDate, endDate, agent, lang) {
    this.reportService.getAccountHoldingFormat2WithEmail(params.PARTICIPANT_ID, startDate, endDate, params.EXCHANGE_ID,
      exchange, params.PARTICIPANT_BRANCH_ID, branch, encodeURIComponent(params.FROM_ACCOUNT.valueOf()),
      encodeURIComponent(params.TO_ACCOUNT.valueOf()), params.SECURITY_ID, security, params.AGENT_ID, agent, lang)
      .subscribe(
        restData => {
          this.loader.hide();
          var reportData: any;
  ...
  public AccountHoldingFormatWithEmail(params, exchange, security, branch, startDate, endDate, agent, lang) {
  ...
  public AccountHoldingFormatWithSMS(params, exchange, security, branch, startDate, endDate, agent, lang) {
    this.loader.show();
  ...
  public AccountHoldingFormatWithActiveSMS(params, exchange, security, branch, startDate, endDate, agent, lang) {
    this.loader.show();
