...
@Component({
  selector: 'agent-uploader-page',
  templateUrl: './agent-uploader-page.html',
})

export class AgentUploaderPage implements OnInit {
  ...
  public btnUpload(model: any, isValid: boolean) {
    ...
    this.listingService.uploadAgents(this.oClientHolding).subscribe(
      data => {
        this.loader.hide();
