...
@Component({
  ...
  templateUrl: './balance-sheet-rpt.html',
  encapsulation: ViewEncapsulation.None,
})
export class BalanceSheetRpt implements OnInit {
  ...
  pdfSrc: String
  pdf = false
  fileNameForDownload = "BalanceSheetRpt.pdf"
 ...
 *********************************/
  ...
  public printReport(model: any, isValid: boolean) {
    ...
    if (isValid) {
      ...
      this.listingService.getBalanceSheetReport(AppConstants.participantId, this.params.HEAD_LEVEL, asOnDateString,this.lang)
        .subscribe(
        restData => {
          this.loader.hide();
          let reportData: any;
