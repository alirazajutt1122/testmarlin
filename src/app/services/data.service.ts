...
export class DataService {
    ...
    constructor(private listingService: ListingService,
     ...
     public verifyOTP(obj): any {
        let url: string = 'http://192.168.36.120:8083/MarlinAPI/nccplData/verifyOTPFromNccpl';

        return this.http.post(url, obj)
            .map(res => AppUtility.isEmpty(res) ? null : res)
    ...
    public getExchangeMarketSecurities() {
      ...
      public getParticipantList(): any {
        let url: string = 'http://192.168.36.120:8083/MarlinAPI/marlin/participants';
